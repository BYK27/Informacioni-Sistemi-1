...
CREATE TABLE `pretplata` (
  `idPretplata` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `FK_idKorisnik_Pretplata` FOREIGN KEY (`idKorisnik`) REFERENCES `podsistem1`.`korisnik` (`idKorisnik`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `FK_idPaket_Pretplata` FOREIGN KEY (`idPaket`) REFERENCES `paket` (`idPaket`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `pretplata` VALUES (1,1,1,'2020-05-06 12:12:12',99.000);
